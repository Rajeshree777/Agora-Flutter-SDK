...
public final class EglCore {
    ...
    public EglCore(EGLContext sharedContext, int flags) {
        ...
        Logger.d("EGL_CONTEXT_CLIENT_VERSION %d", values[0]);
    }
    ...
    private EGLConfig getConfig(int flags, int version) {
        ...
        if (!EGL14.eglChooseConfig(
            ...
            Logger.w("unable to find RGB8888 / %s EGLConfig", version);
            return null;
        }
        return configs[0];
    }
    ...
    protected void finalize() throws Throwable {
        try {
            if (mEGLDisplay != EGL14.EGL_NO_DISPLAY) {
                ...
                Logger.w("finalize: mEGLDisplay != EGL_NO_DISPLAY in EglCore");
                release();
            }
        } finally {
            super.finalize();
    ...
    public static void logCurrent(String msg) {
        ...
        Logger.i(
            "Current EGL ( %1$s ): display= %2$s, context= %3$s, surface=%4$s",
            msg,
            display,
            context,
            surface);

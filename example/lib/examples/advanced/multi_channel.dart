...
class _State extends State<MultiChannel> {
  ...
  _joinChannel0() async {
    ...
    await widget._channel0
        .joinChannel(null, null, 0, ChannelMediaOptions(autoSubscribeAudio: true, publishLocalAudio: true,));
  }
  ...
  _joinChannel1() async {
    ...
    await widget._channel1
        .joinChannel(null, null, 0, ChannelMediaOptions(autoSubscribeAudio:true, autoSubscribeVideo: true));
  }
